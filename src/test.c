...
START_TEST(strntollu_test1) {
    char src[] = "-11";
    ck_assert_int_eq(s21_strntollu(src, s21_NULL, 19, 2), -20);
} END_TEST
// strntollu <-
*/
...
START_TEST(strtold_Doubles1) {
    ...
    a1 = s21_strtold(str1);
    a2 = strtold(str1, s21_NULL);

    b1 = s21_strtold(str2);
    b2 = strtold(str2, s21_NULL);

    c1 = s21_strtold(str3);
    c2 = strtold(str3, s21_NULL);

    d1 = s21_strtold(str4);
    d2 = strtold(str4, s21_NULL);
...
Suite *suite_insert(void) {
  ...
  */
  ...
  /*
  // // Doubles
  tcase_add_test(tc, strtold_Doubles1);
  tcase_add_test(tc, strtold_Doubles2);
  tcase_add_test(tc, strtold_Doubles3);
  tcase_add_test(tc, strtold_Doubles4);

  // // Doubles with expon (e)
  tcase_add_test(tc, strtold_expon1);
  tcase_add_test(tc, strtold_expon2);
  tcase_add_test(tc, strtold_expon3);
  tcase_add_test(tc, strtold_expon4);

  // // Infinity, Nan
  tcase_add_test(tc, strtold_inf_nan1);
  tcase_add_test(tc, strtold_inf_nan2);
  tcase_add_test(tc, strtold_inf_nan3);
  tcase_add_test(tc, strtold_inf_nan4);

  // // Mixed
  tcase_add_test(tc, strtold_Mixed1);
  tcase_add_test(tc, strtold_Mixed2);
  tcase_add_test(tc, strtold_Mixed3);
  tcase_add_test(tc, strtold_Mixed4);
  tcase_add_test(tc, strtold_Mixed5);
  tcase_add_test(tc, strtold_Mixed6);
  tcase_add_test(tc, strtold_Mixed7);
  tcase_add_test(tc, strtold_Mixed8);
  tcase_add_test(tc, strtold_Mixed9);
  tcase_add_test(tc, strtold_Mixed10);
  tcase_add_test(tc, strtold_Mixed11);
  tcase_add_test(tc, strtold_Mixed12);
  */
